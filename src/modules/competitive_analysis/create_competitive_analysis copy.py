...
async def create_competitive_analysis(
    ...
    # func_spec = {
    #     "name": "create_competitive_analysis",
    #     "description": "Extract structured information from FDA product profiles for comparison",
    #     "parameters": {
    #         "type": "object",
    #         "properties": {
    #             "product_name": {
    #                 "type": "string",
    #                 "description": "The name of the medical device or product. It is NOT a number like K243813 "
    #                 "It should be Trade/Device Name, for example, iDart Lyme IgG ImmunoBlot Kit",
    #             },
    #             "regulatory_pathway": {
    #                 "type": "string",
    #                 "description": "The regulatory pathway, e.g., 510(k), PMA, De Novo, etc.",
    #             },
    #             # ... add other fields ...
    #         },
    #         "required": ["product_name", "regulatory_pathway"]
    #     },
    # }
    ...
    # product_name = parsed_args.get("product_name", "Not Available")
