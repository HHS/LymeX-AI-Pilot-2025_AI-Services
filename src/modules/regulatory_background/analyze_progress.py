...
from src.modules.regulatory_background.model import AnalyzeRegulatoryBackgroundProgress


class AnalyzeProgress:
    def __init__(self):
        self.progress: AnalyzeRegulatoryBackgroundProgress | None = None

    async def initialize(self, product_id: str, total_files: int):
        existing = await AnalyzeRegulatoryBackgroundProgress.find_one(
        ...
        if existing:
            ...
            self.progress = AnalyzeRegulatoryBackgroundProgress(
